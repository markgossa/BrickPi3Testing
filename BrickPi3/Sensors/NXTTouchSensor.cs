...
namespace BrickPi3.Sensors
{
    public sealed class NXTTouchSensor: ISensor
    {
        ...
        public NXTTouchSensor(Brick brick, BrickPortSensor port):this(brick, port, 1000)
        { }
        /// <summary>
        /// Initialize a new NXT Touch sensor
        /// </summary>
        ...
        public NXTTouchSensor(Brick brick, BrickPortSensor port, int timeout)
        {
            this.brick = brick;
            Port = port;
            //brick.BrickPi.Sensor[(int)Port].Type = BrickSensorType.TOUCH;
            brick.set_sensor_type((byte)Port, SENSOR_TYPE.NXT_TOUCH);
